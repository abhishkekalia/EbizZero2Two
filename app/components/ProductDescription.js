...
class ProductDescription extends Component {
  ...
  onOpen() {
        ...
        .then((responseData) => {
            ...
            if(responseData.status){
                this.setState({
                    ...
                    status : true,
                    vendor_id:responseData.data.vendor_id
                });
            }
        })
        .catch((error) => {
            ...
            <View style={styles.container}>
                ...
                <View style={{
                    ...
                    <Text style={{color:'#a9d5d1', textAlign: (lang === 'ar') ? 'right': 'left'}}>{I18n.t('productdetail.selctsize', { locale: lang })}</Text>
                        ...
                        <AllItem product_category={this.state.data.product_category} vendor_id={this.state.vendor_id}/>
                    </View>
    ...
    decrement () {
        ...
        return (
                <TouchableOpacity style={{ flexDirection: (lang === 'ar') ? 'row-reverse': 'row' ,padding : 10}} onPress= {()=>this.order(data.address_id)}>
